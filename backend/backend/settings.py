...
SECRET_KEY = 'django-insecure-_-v)s$e4ob@_6_ip^j82l^=ci$!+uuv!9&kr@fa%^xl9)1q(sy'
...
JAZZMIN_SETTINGS = {
    'site_title': 'Divine\'s LMS Admin',
    'site_header': 'Divine\'s LMS',
    'site_brand': 'Divine\'s LMS',
    'welcome_sign': 'Welcome to divine\'s Learning management system site',
    'copyright': 'Divine\'s Learning management systen 2024',
    'show_sidebar': True,
