...
function Coupon() {
   ...
   const handleCouponUpdateSubmit = (e) => {
      ...
      formdata.append("teacher", teacherId);
      formdata.append("code", selectedCoupon.code);
      formdata.append("discount", selectedCoupon.discount);

      useAxios()
         .patch(`teacher/coupon-detail/${teacherId}/${selectedCoupon.id}/`, formdata)
         .then((res) => {
            console.log(res.data);
            fetchCoupons();
            handleClose();
            ...
            <Modal.Body>
               <form onSubmit={handleCouponUpdateSubmit}>
                  <div class="mb-3">
                     ...
                     <input type="text" placeholder="Code" defaultValue={selectedCoupon.code} className="form-control" name="code" onChange={handleUpdateCoupon} />
                     <label for="exampleInputEmail1" class="form-label mt-3">
                        Discount
                     </label>
                     <input type="text" placeholder="Discount" defaultValue={selectedCoupon.discount} className="form-control" name="discount" onChange={handleUpdateCoupon} id="" />
                  </div>
