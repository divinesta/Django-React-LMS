...
const Success = () => {
   ...
   return (
      <>
         ...
         <section className="pt-0 mt-5 position-relative overflow-hidden my-auto">
                  ...
                  {orderMessage === "Payment Successful" && (
                     <>
                        <div className="col-lg-5">
                           ...
                           <p>
                              {" "}
                              Hey there, you enrollment in the 2 courses where
                              successful, visit your <a href="">
                                 My Courses
                              </a>{" "}
                        ...
                        <div className="col-lg-7 text-center">
                           <img
                              src="https://files.oaiusercontent.com/file-pWSjvAHVF5OGZBbOCbNYexbf?se=2024-09-18T12%3A48%3A48Z&sp=r&sv=2024-08-04&sr=b&rscc=max-age%3D604800%2C%20immutable%2C%20private&rscd=attachment%3B%20filename%3Da198e9ef-60b6-46e9-8828-faa8234547c7.webp&sig=E37Piqc4%2BTc/O/pAMpRAZ2nfB9m79ZB7ZQ7PfzGeCsE%3D"
                              className="h-300px h-sm-400px h-md-500px h-xl-700px w-50"
                              alt=""
                           />
                        </div>
                     </>
                  ...
                  {orderMessage === "Processing Payment..." && (
                     <>
                        <div className="col-lg-5">
                           ...
                           <p>
                              {" "}
                              Hey there, hold on while we process your payment,
                  ...
                  {orderMessage === "Payment Failed" && (
                     <>
                        <div className="col-lg-5">
                           ...
                           <p>
                              Unfortunately, phew! Your payment did not go
                              through. <br /> Please try again.
                           </p>
                           <button
                              type="button"
