               ...
               <div className="row mb-5 mt-3">
                  ...
                  <div className="col-12">
                     <div className="mb-6">
                        ...
                        <p>
                           These are the most popular courses among Geeks
                           Courses learners worldwide in year 2022
                        </p>
                     </div>
                  </div>
               </div>
                  ...
                  <div className="col-lg-5 col-12">
                     <div className="text-white p-5 p-lg-0">
                        ...
                        <p className="mb-0">
                           ...
                           students on Geeks. We provide the tools and skills to
                           teach what you love.
                        </p>
                        <a
                           href="#"
                        ...
                        <div className="col-lg-6 col-md-8">
                           ...
                           <div>
                              ...
                              <p className="mb-0">
                                 ...
                                 <span className="text-dark">trainers</span>,
                                 and
                                 <span className="text-dark">leaders</span>
                                 in the learning space about how Geeks empowers
                                 them to provide quality online learning
                                 experiences.
                              </p>
                           </div>
                        </div>
                                    ...
                                    <div className="card">
                                       <div className="card-body text-center p-6">
                                          ...
                                          <p className="mb-0 mt-3">
                                             ...
                                             words etc generate lorem Ipsum
                                             which looks racteristic
                                             reasonable.”
                                          </p>
                                          {/* rating */}
